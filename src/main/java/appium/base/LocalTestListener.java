...
//		test.pass(result.getThrowable());
	...
	public void onTestFailure(ITestResult result) {
		...
		if(testName.contains("Android")){
			testThread.get().addScreenCaptureFromPath(BaseMethodsAndroid.takeScreenshot(result.getMethod().getMethodName()), result.getMethod().getMethodName());
		}else if (testName.contains("iOS")){
			testThread.get().addScreenCaptureFromPath(BaseMethodsIOS.takeScreenshot(result.getMethod().getMethodName()), result.getMethod().getMethodName());
		}
